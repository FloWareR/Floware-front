  ...
  return (
    <div className="fixed inset-0 bg-gray-900 text-white flex items-center justify-center z-50">
      ...
      <div className="relative z-10 p-6 bg-blue-600 rounded-lg shadow-lg max-w-sm text-center">
        <h2 className="text-2xl font-semibold mb-4">Oops! This site is desktop only!</h2>
        <p className="text-lg mb-6">For the best experience, please download our mobile app from Google Play.</p>
